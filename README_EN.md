...
### On-device preview (an app built on this base project: Plane shooter, solo / 2-player Bluetooth)

| Mode select | Game over |
|---|---|
| ![Plane mode select](screenshot/game-plane-menu.jpg) | ![Plane game over](screenshot/game-plane-gameover.jpg) |
